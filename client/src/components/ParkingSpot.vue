<script setup lang="ts">
    ...
    const colourClasses = computed(() => {
        if(props.spot.booked_by_user && !parkingStore.reservationArrived) return "border-slate-500 text-slate-500";
...
<template>
    ...
    >
        ...
        <div 
            v-if="props.spot.booked_by_user && !parkingStore.reservationArrived" 
