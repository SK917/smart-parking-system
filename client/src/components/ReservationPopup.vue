...
<template>
    <Teleport to="body">
        ...
        >
            <div v-if="parkingStore.reservationStatus.success">
            ...
            <div v-else>
                <div class="bg-white border-2 border-red-300 p-8 rounded-lg shadow-2xl max-w-sm w-full font-chakra">
                    <h2 class="text-2xl font-bold text-red-500 mb-4 uppercase text-center">
                        Reservation Failed
                    </h2>
                    ...
                    <button
                        @click="emit('confirm')"
                        class="w-full bg-red-200 hover:bg-red-400 text-gray-700 text-xl font-bold py-3 rounded uppercase transition-colors cursor-pointer"
                    >
                        Confirm
                    </button>
                </div>
